...
"[project]/lib/store/file.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function createFileStore(dir = __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["default"].join(process.cwd(), ".data")) {
    ...
    return {
        createUser: (input)=>run(true, (db)=>{
                if (db.users.some((u)=>u.email === input.email)) throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2f$types$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["EmailTakenError"]();
                const user = {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__19hhfjs._.js.map