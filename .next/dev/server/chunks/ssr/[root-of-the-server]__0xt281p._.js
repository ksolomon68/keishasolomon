...
"[project]/.next-internal/server/app/admin/page/actions.js { ACTIONS_MODULE0 => \"[project]/app/actions/auth.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE1 => \"[project]/app/actions/admin.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s([
    ...
    "40ea7c63c1b31298e4c0d7c23a2fb10f6e826d0ac7",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$admin$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["deleteResourceAction"],
    "6027e0607455524f18438b6be618733843747b090b",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$admin$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["uploadResourceAction"],
    "7002b049b0b4c1aaf954230bf61e5ddd72965183e8",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$admin$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["setAttendanceAction"],
    "70aa9c8931e0d65a8f11383f917f8ebcc853ca9bc3",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$admin$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["setDeliverableStatusAction"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f2e$next$2d$internal$2f$server$2f$app$2f$admin$2f$page$2f$actions$2e$js__$7b$__ACTIONS_MODULE0__$3d3e$__$225b$project$5d2f$app$2f$actions$2f$auth$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE1__$3d3e$__$225b$project$5d2f$app$2f$actions$2f$admin$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$server__actions__loader$2c$__ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i('[project]/.next-internal/server/app/admin/page/actions.js { ACTIONS_MODULE0 => "[project]/app/actions/auth.ts [app-rsc] (ecmascript)", ACTIONS_MODULE1 => "[project]/app/actions/admin.ts [app-rsc] (ecmascript)" } [app-rsc] (server actions loader, ecmascript) <locals>');
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$admin$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/actions/admin.ts [app-rsc] (ecmascript)");
}),
"[project]/.next-internal/server/app/admin/page/actions.js { ACTIONS_MODULE0 => \"[project]/app/actions/auth.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE1 => \"[project]/app/actions/admin.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/actions/admin.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";

/* __next_internal_action_entry_do_not_use__ [{"40ea7c63c1b31298e4c0d7c23a2fb10f6e826d0ac7":{"name":"deleteResourceAction"},"6027e0607455524f18438b6be618733843747b090b":{"name":"uploadResourceAction"},"7002b049b0b4c1aaf954230bf61e5ddd72965183e8":{"name":"setAttendanceAction"},"70aa9c8931e0d65a8f11383f917f8ebcc853ca9bc3":{"name":"setDeliverableStatusAction"}},"app/actions/admin.ts",""] */ __turbopack_context__.s([
...
/** The target must be a real participant; admins have no cohort progress to edit. */ async function participantId(userId) {
    const user = await (await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2f$index$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getStore"])()).findUserById(idSchema.parse(userId));
    if (!user || user.role !== "participant") throw new Error("Unknown participant.");
    return user.id;
}
async function setAttendanceAction(userId, sessionId, present) {
    ...
    await (await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2f$index$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getStore"])()).setAttendance(await participantId(userId), __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$validation$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["sessionIdSchema"].parse(sessionId), present);
...
async function setDeliverableStatusAction(userId, sessionId, status) {
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2f$session$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["requireAdmin"])("/admin");
    const parsedStatus = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].enum(__TURBOPACK__imported__module__$5b$project$5d2f$data$2f$cohortData$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["deliverableStatuses"].map((s)=>s.value)).parse(status);
    const parsedSession = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$validation$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["sessionIdSchema"].parse(sessionId);
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$cohortData$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["sessionById"])(parsedSession)?.deliverable) throw new Error("That session has no deliverable.");
    await (await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2f$index$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getStore"])()).upsertDeliverable(await participantId(userId), parsedSession, {
        status: parsedStatus
    });
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["revalidatePath"])("/admin");
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["revalidatePath"])("/dashboard");
}
async function uploadResourceAction(_prev, formData) {
    const admin = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2f$session$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["requireAdmin"])("/admin");
    ...
    const parsed = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$validation$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["resourceSchema"].safeParse(Object.fromEntries(formData));
    ...
    if (hasFile) {
        try {
            fileId = (await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$uploads$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["saveUpload"])(upload, admin.id)).id;
        } catch (error) {
    ...
    await (await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2f$index$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getStore"])()).createResource({
        ...parsed.data,
        fileId,
        createdBy: admin.id
    });
    ...
    return {
        ok: true,
        message: `Added "${parsed.data.title}".`
    };
}
async function deleteResourceAction(id) {
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2f$session$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["requireAdmin"])("/admin");
    const removed = await (await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2f$index$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getStore"])()).deleteResource(idSchema.parse(id));
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$uploads$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["removeFile"])(removed?.fileId ?? null);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["revalidatePath"])("/admin");
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["revalidatePath"])("/dashboard");
}
;
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(setAttendanceAction, "7002b049b0b4c1aaf954230bf61e5ddd72965183e8", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(setDeliverableStatusAction, "70aa9c8931e0d65a8f11383f917f8ebcc853ca9bc3", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(uploadResourceAction, "6027e0607455524f18438b6be618733843747b090b", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(deleteResourceAction, "40ea7c63c1b31298e4c0d7c23a2fb10f6e826d0ac7", null);
}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0xt281p._.js.map