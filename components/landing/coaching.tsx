...
export function CoachingSupport() {
  return (
    <section aria-labelledby="coaching-support-title" className="bg-paper py-20 sm:py-28">
      <div className="mx-auto grid max-w-7xl gap-px border border-navy-900 bg-navy-900 px-0 sm:grid-cols-[1.08fr_.92fr] lg:grid-cols-[1.2fr_.8fr]">
        ...
        <div data-surface="dark" className="grid-backdrop bg-navy-950 p-7 text-white sm:p-10 lg:p-14">
